" Vim color file
"
" Author: Dimitrij Borisov
"
" Note: Based on darkspectrum for MacVim
"
" cool help screens
" :he group-name
" :he highlight-groups
...
let g:colors_name="marschal"

hi Normal guifg=#b3b8bb guibg=#2A2A2A

" highlight groups
hi Cursor		guibg=#ffffff guifg=#000000
hi CursorLine	guibg=#8b0000
"hi CursorColumn	guibg=#464646
hi CursorColumn	guibg=#8b0000
...
hi Search		guibg=#8b0000 guifg=#b3b8bb
hi SpecialKey	guifg=#2a393b

hi Title		guifg=#ef5939
hi WarningMsg	guifg=#8b0000
hi Number		guifg=#BC5E00

hi MatchParen	guibg=#ad7fa8 guifg=#FFFFFF
hi Comment		guifg=#496A44
hi Constant		guifg=#ef5939 gui=none
hi String		guifg=#c8a553
hi Identifier	guifg=#729fcf
hi Statement	guifg=#30539A gui=bold
hi PreProc		guifg=#4b3e88 gui=bold
hi Type			guifg=#5f8b32 gui=bold
hi Special		guifg=#9C4625
hi Underlined	guifg=#ad7fa8 gui=underline
hi Directory	guifg=#729fcf
hi Ignore		guifg=#555753
hi Todo			guifg=#b3b8bb guibg=#8b0000 gui=bold
hi Function		guifg=#23819A
hi Operator		guifg=#7F7B7A
hi Delimiter	guifg=#9A0001
